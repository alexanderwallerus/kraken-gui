...
def setup():
    ...
    plt0 = krakengui.Plot(x=10, y= 10, w=500, h=500)
    plt1 = krakengui.Plot( x=10, y=570, w=500, h=200, sketch=py5.get_current_sketch())
...
def draw():
    ...
    krakengui.legend({'red': (255, 0, 0)}, 100, 485, frame=False)

    legend = krakengui.legend({'graph 0': (0, 255, 255), 'graph 1': (255, 0, 0), 'scatter': (255,)},
    ...
    plt2 = krakengui.Plot(x=0, y=0, w=500, h=200)
    ...
    # krakengui.print_coordinates(py5.get_current_sketch())
